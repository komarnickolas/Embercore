...
#include "EmbercoreDamageExecCalculation.h"

#include "EmbercoreAbilitySystemComponent.h"
...
struct GDDamageStatics {
	...
	GDDamageStatics() {
		...
		DEFINE_ATTRIBUTE_CAPTUREDEF(UEmbercoreAttributeSet, Damage, Source, true);

		// Capture the Target's Armor. Don't snapshot.
		DEFINE_ATTRIBUTE_CAPTUREDEF(UEmbercoreAttributeSet, Armor, Target, false);
	}
};
...
UEmbercoreDamageExecCalculation::UEmbercoreDamageExecCalculation() {
	RelevantAttributesToCapture.Add(DamageStatics().DamageDef);
	RelevantAttributesToCapture.Add(DamageStatics().ArmorDef);
}

void UEmbercoreDamageExecCalculation::Execute_Implementation(
	...
	UEmbercoreAbilitySystemComponent* TargetASC = Cast<UEmbercoreAbilitySystemComponent>(TargetAbilitySystemComponent);
	if (TargetASC) {
		UEmbercoreAbilitySystemComponent* SourceASC = Cast<UEmbercoreAbilitySystemComponent>(
