...
class EMBERCORE_API UAsyncTaskEffectStackChanged : public UBlueprintAsyncActionBase {
	GENERATED_BODY()
	...
	static UAsyncTaskEffectStackChanged* ListenForGameplayEffectStackChange(
