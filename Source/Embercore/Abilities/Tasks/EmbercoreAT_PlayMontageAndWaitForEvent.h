...
#include "EmbercoreAT_PlayMontageAndWaitForEvent.generated.h"

/** Delegate type used, EventTag and Payload may be empty if it came from the montage callbacks */
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FEmbercorePlayMontageAndWaitForEventDelegate, FGameplayTag, EventTag,
 ...
 */
UCLASS()
class EMBERCORE_API UEmbercoreAT_PlayMontageAndWaitForEvent : public UAbilityTask {
	GENERATED_BODY()

public:
	// Constructor and overrides
	UEmbercoreAT_PlayMontageAndWaitForEvent(const FObjectInitializer& ObjectInitializer);
	...
	*/
	...
	FEmbercorePlayMontageAndWaitForEventDelegate OnCompleted;

	/** The montage started blending out */
	UPROPERTY(BlueprintAssignable)
	FEmbercorePlayMontageAndWaitForEventDelegate OnBlendOut;

	/** The montage was interrupted */
	UPROPERTY(BlueprintAssignable)
	FEmbercorePlayMontageAndWaitForEventDelegate OnInterrupted;

	/** The ability task was explicitly cancelled by another ability */
	UPROPERTY(BlueprintAssignable)
	FEmbercorePlayMontageAndWaitForEventDelegate OnCancelled;

	/** One of the triggering gameplay events happened */
	UPROPERTY(BlueprintAssignable)
	FEmbercorePlayMontageAndWaitForEventDelegate EventReceived;
	...
	static UEmbercoreAT_PlayMontageAndWaitForEvent* PlayMontageAndWaitForEvent(
...
private:
	...
	UEmbercoreAbilitySystemComponent* GetTargetASC();
