...
#include "EmbercoreCharacterMovementComponent.generated.h"

/**
 * 
 */
UCLASS()
class EMBERCORE_API UEmbercoreCharacterMovementComponent : public UCharacterMovementComponent {
	GENERATED_BODY()
...
public:
	UEmbercoreCharacterMovementComponent();
