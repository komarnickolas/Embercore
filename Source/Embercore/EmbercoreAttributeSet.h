...
#include "EmbercoreAttributeSet.generated.h"
...
UCLASS()
class EMBERCORE_API UEmbercoreAttributeSet : public UAttributeSet {
	GENERATED_BODY()

public:
	UEmbercoreAttributeSet();
	...
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, Health)

	// MaxHealth is its own attribute since GameplayEffects may modify it
	UPROPERTY(BlueprintReadOnly, Category = "Health", ReplicatedUsing = OnRep_MaxHealth)
	FGameplayAttributeData MaxHealth;
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, MaxHealth)
	...
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, Armor)

	// Damage is a meta attribute used by the DamageExecution to calculate final damage, which then turns into -Health
	// Temporary value that only exists on the Server. Not replicated.
	UPROPERTY(BlueprintReadOnly, Category = "Damage")
	FGameplayAttributeData Damage;
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, Damage)

	// MoveSpeed affects how fast characters can move.
	UPROPERTY(BlueprintReadOnly, Category = "MoveSpeed", ReplicatedUsing = OnRep_MoveSpeed)
	FGameplayAttributeData MoveSpeed;
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, MoveSpeed)

	UPROPERTY(BlueprintReadOnly, Category = "Character Level", ReplicatedUsing = OnRep_CharacterLevel)
	FGameplayAttributeData CharacterLevel;
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, CharacterLevel)
	...
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, XP)
	...
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, XPBounty)
	...
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, Gold)
	...
	ATTRIBUTE_ACCESSORS(UEmbercoreAttributeSet, GoldBounty)
